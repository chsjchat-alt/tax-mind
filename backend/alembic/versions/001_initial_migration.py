...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('industry', sa.Enum('批发零售', '制造', '建筑', '电商', '餐饮服务',
        ...
        sa.Column('risk_level', sa.Enum('low', 'medium', 'high',
    ...
    op.create_table(
        ...
        sa.Column('direction', sa.Enum('inflow', 'outflow',
                  name='direction_type', create_type=False), nullable=False, comment='方向'),
        sa.Column('account_type', sa.Enum('corporate', 'personal',
    ...
    op.create_table(
        ...
        sa.Column('invoice_type', sa.Enum('input', 'output',
    ...
    op.create_table(
        ...
        sa.Column('enterprise_id', postgresql.UUID(as_uuid=True),
                  sa.ForeignKey('enterprises.id', ondelete='CASCADE'), nullable=False, comment='企业ID'),
        sa.Column('tax_type', sa.Enum('vat', 'income_tax', 'personal_income_tax',
    ...
    op.create_table(
        ...
        sa.Column('contract_type', sa.Enum('sales', 'purchase',
    ...
    op.create_table(
        ...
        sa.Column('statement_type', sa.Enum('balance_sheet', 'income_statement', 'cash_flow',
    ...
    op.create_table(
        ...
        sa.Column('overall_risk_level', sa.Enum('low', 'medium', 'high',
    ...
    op.create_table(
        ...
        sa.Column('priority', sa.Enum('high', 'medium', 'low',
